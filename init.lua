...
vim.o.splitbelow = false -- AS changed
...
require('lazy').setup({
    ...
    config = function()
      require('gitsigns').setup {
        ...
        on_attach = function(bufnr)
          ...
          -- Text object
          map({ 'o', 'x' }, 'ih', gitsigns.select_hunk, { desc = '[ih] select hunk' })
        end,
      }
    end,
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'javascript', 'jinja', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
